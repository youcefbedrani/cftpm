-- ============================================================================
-- CFTMP — full schema for self-hosted Postgres
-- This script is run by `node scripts/migrate.js` against $DATABASE_URL.
...
-- ===== PROFILES =====
-- password_hash holds a bcrypt hash (no plaintext anywhere on the server)
